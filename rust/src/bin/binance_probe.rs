//! Binance WS endpoint comparison probe.
//!
//! Tests read-only market-data access (btcusdt@bookTicker) on each of:
//!   1. stream.binance.com:9443          (primary spot stream, AWS regional)
//!   2. data-stream.binance.vision       (public data mirror — Tokyo-only)
//!   3. fstream.binance.com              (USDT-M futures stream, AWS regional)
//!
//! For each: resolves DNS, opens WS, subscribes, collects N messages,
//! reports TCP connect RTT, WS open time, and inter-message intervals.
...
/// AWS IP → rough region, for the most common Binance ranges.
